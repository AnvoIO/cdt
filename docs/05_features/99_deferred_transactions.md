...
| Deferred transactions have been deprecated since the legacy EOSIO 2.0 release and remain deprecated in Anvo Network. They should not be used in new contracts.
