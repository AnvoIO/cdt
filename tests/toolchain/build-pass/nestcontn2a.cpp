 ...
 *
 * Expected printout:
 *      For each setx action, the printed result on the core-cli console is given in its corresponding prntx action.
 */
...
class [[clang::annotate("core_net::contract", "nestcontn2a")]] nestcontn2a : public core_net::contract {
    ...
    public:
        ...
        {
            SETCONTAINERVAL(v);
            core_net::print("vector<uint16_t> stored successfully");
        }

        /*Examples:
         *  core-cli --verbose push action nestcontn2a prntv '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("size of stored v:", iter->v.size()," vals of v:");
        ...
        {
            SETCONTAINERVAL(st);
            core_net::print("set<uint16_t> stored successfully");
        }

        /*Examples:
         *  core-cli --verbose push action nestcontn2a prntst '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("size of stored st:", iter->st.size()," vals:");
         ...
         *   core-cli --verbose push action nestcontn2a setm '["alice", [{"key":"str1","value":"str1val"}, {"key":"str3","value":"str3val"}]]' -p alice@active
         *
         * To use full JSON notation:
         *   core-cli --verbose push action nestcontn2a setm '{"user":"jane", "m":[{"key":"str4", "value":"str4val"}, {"key":"str6", "value":"str6val"}]}' -p jane@active
         *
        ...
        {
            SETCONTAINERVAL(m);
            core_net::print("map<string,string> stored successfully");
        }

        /* Examples:
         *  core-cli --verbose push action nestcontn2a prntm '["alice"]' -p alice@active
         *      output: >> size of stored m:2 vals of m:str1:str1val  str3:str3val
         *
         *  core-cli --verbose push action nestcontn2a prntm '["jane"]' -p jane@active
        ...
        */
        ...
        {
            PRNTCHECK();
            core_net::print("size of stored m:", iter->m.size()," vals of m:");
            for (auto it2 = iter->m.begin(); it2 != iter->m.end(); ++it2)
                core_net::print(it2->first, ":", it2->second, "  ");
        ...
        {
            SETCONTAINERVAL(s);
            core_net::print("mystruct stored successfully");
        }
        ...
        {
            PRNTCHECK();
            core_net::print("stored mystruct val:", iter->s._count,",", iter->s._strID);
        }
        ...
        {
            SETCONTAINERVAL(s2);
            core_net::print("complex mystruct2 stored successfully");
        }
        ...
        {
            PRNTCHECK();
            core_net::print("stored mystruct2 val:", iter->s2._structfld._count,",", iter->s2._structfld._strID, ",", iter->s2._strID2);
        }
        ...
        {
            SETCONTAINERVAL(vs);
            core_net::print("vector<mystruct> stored successfully");
        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntvs '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("stored vector<mystruct>  size=",iter->vs.size(), ":\n");
            for (const auto& ele: iter->vs)
            {
                core_net::print(ele._count,",", ele._strID,"\n");
            }
        }

        /*Examples
         *  To pass a null value:
         *      core-cli --verbose push action nestcontn2a seto '["bob", null]' -p bob@active
         *
        ...
        {
            SETCONTAINERVAL(o);
            core_net::print("optional<string> stored successfully");
        }

        /*Examples:
         *  core-cli --verbose push action nestcontn2a  prnto '["bob"]' -p bob@active
        ...
        void prnto(name user)
        {
            PRNTCHECK();
            if (iter->o)
                core_net::print("stored optional<string> =", iter->o.value());
            else
                core_net::print("stored optional<string>  has null value!");
        }
        ...
        {
            SETCONTAINERVAL(p);
            core_net::print("pair<uint16_t, uint16_t> stored successfully");
        }
        ...
        {
            PRNTCHECK();
            core_net::print("stored pair<uint16_t,uint16_t> val:", iter->p.first,",", iter->p.second);
        }
        ...
        {
            SETCONTAINERVAL(vst);
            core_net::print("type defined vector<set_uint16> stored successfully!");

        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntvst '["alice"]' -p alice@active
        ...
        void prntvst(name user)
        {
            ...
            PRNTCHECK();
            core_net::print("stored vector<set<T>>:size=", iter->vst.size(), " vals:\n");
        ...
        {
            SETCONTAINERVAL(vv);
            core_net::print("type defined vector<vec_uint16> stored successfully!");

        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntvv '["alice"]' -p alice@active
        ...
        void prntvv(name user)
        {
            ...
            PRNTCHECK();
            core_net::print("stored vector<vector<T>> vals:\n");
            for (int i=0 ; i < iter->vv.size(); i++)
            {
                for (int j=0; j < iter->vv[i].size(); j++)
                    core_net::print(iter->vv[i][j], " ");
                core_net::print("\n"); //--- use core-cli --verbose to show new lines !!!
            }
        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a setvo '["alice", [100, null, 200, null, 300]]' -p alice@active
        ...
        {
            SETCONTAINERVAL(vo);
            core_net::print("type defined vector<optional<T> > stored successfully!");
        }
        ...
        {
            PRNTCHECK();
            core_net::print("stored vector<op_uint16> vals:\n");
            for (const auto& ele : iter->vo)
            {
                if (ele)
                    core_net::print(ele.value(), " ");
                else
                    core_net::print("NULL", " ");
            }
        }
        ...
        {
            SETCONTAINERVAL(vm);
            core_net::print("type defined vector<map<K, V> > stored successfully!");
        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntvm '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("stored vector<mp_uint16>: size=", iter->vm.size()," content:\n");
            int count=0;
        ...
        {
            SETCONTAINERVAL(vp);
            core_net::print("vector<pair<uint32_t, uint32_t> > stored successfully");
        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntvp '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("stored vector<pair<uint32_t, uint32_t> >  size=",iter->vp.size(), ":\n");
            for (const auto& ele: iter->vp)
            {
                core_net::print(ele.first,",", ele.second,"\n");
            }
        }
        ...
        void setstst(name user, const set<set_uint16>& stst)
        {
            ...
            core_net::print("type defined set<set_uint16> stored successfully!");

        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntstst '["alice"]' -p alice@active
        ...
        void prntstst(name user)
        {
            ...
            PRNTCHECK();
            core_net::print("stored set<set<T>>:size=", iter->stst.size(), " vals:\n");
        ...
        {
            SETCONTAINERVAL(stv);
            core_net::print("type defined set<vec_uint16> stored successfully!");
        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntstv '["alice"]' -p alice@active
        ...
        void prntstv(name user)
        {
            ...
            PRNTCHECK();
            core_net::print("stored set<vector<T>>:size=", iter->stv.size(), " vals:\n");
        ...
        /*Example:
         *  core-cli --verbose push action nestcontn2a setsto '["alice", [101, null, 201, 301]]' -p alice@active
        ...
        {
            SETCONTAINERVAL(sto);
            core_net::print("type defined set<optional<T> > stored successfully!");
        }
        ...
        {
            SETCONTAINERVAL(stm);
            core_net::print("type defined set<map<K, V> > stored successfully!");
        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntstm '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("stored set<mp_uint16>: size=", iter->stm.size()," content:\n");
            int count=0;
        ...
        {
            SETCONTAINERVAL(stp);
            core_net::print("set<pair<T1,T2 >> stored successfully");
        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntstp '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("stored set<pair<uint32_t, uint32_t> >  size=",iter->stp.size(), ":\n");
        ...
        {
            SETCONTAINERVAL(ost);
            core_net::print("type defined optional<set<T> > stored successfully!");
        }

        /*Examples:
         *  core-cli --verbose push action nestcontn2a  prntost '["bob"]' -p bob@active
         *      output: >> stored optional<set_uint16>  vals:
         *              >> NULL or no value
         *
         *  core-cli --verbose push action nestcontn2a  prntost '["alice"]' -p alice@active
         *      output: >> stored optional<set_uint16>  vals:
         *              >> 1006 2006 3006
         */
        [[clang::annotate("core_net::action")]]
        ...
        {
            PRNTCHECK();
            core_net::print("stored optional<set_uint16>  vals:\n");
            if (iter->ost)
            {
                ...
                core_net::print("NULL or no value");
        }



        /*Examples:
         *  core-cli --verbose push action nestcontn2a setov '["bob", null]' -p bob@active
         *
        ...
        {
            SETCONTAINERVAL(ov);
            core_net::print("type defined optional<vector<T> > stored successfully!");
        }

        /*Examples:
         *  core-cli --verbose push action nestcontn2a  prntov '["bob"]' -p bob@active
         *      output: >> stored optional<vec_uint16>  vals:
         *              >> NULL or no value
         *
         *  core-cli --verbose push action nestcontn2a  prntov '["alice"]' -p alice@active
         *      output: >> stored optional<vec_uint16>  vals:
         *              >> 1001 2001 3001
         */
        [[clang::annotate("core_net::action")]]
        ...
        {
            PRNTCHECK();
            core_net::print("stored optional<vec_uint16>  vals:\n");
            if (iter->ov)
            {
        ...
        /*Examples:
         *  core-cli --verbose push action nestcontn2a setoo '["bob", null]' -p bob@active
         *
        ...
        {
            SETCONTAINERVAL(oo);
            core_net::print("type defined optional<op_uint16> stored successfully!");
        }

        /*Examples:
         *  core-cli --verbose push action nestcontn2a  prntoo '["bob"]' -p bob@active
        ...
        {
            PRNTCHECK();
            core_net::print("stored optional<optional<T>> val:");
            if (iter->oo && iter->oo.value())
                core_net::print(iter->oo.value().value(),"\n");
            else
                core_net::print("null or no real value stored");
        }

        /*Examples:
         *  core-cli --verbose push action nestcontn2a  setom '["alice",[{"first":10,"second":1000},{"first":11,"second":1001}] ]' -p alice@active
         *
        ...
        {
            SETCONTAINERVAL(om);
            core_net::print("type defined optional<map<K, V> > stored successfully!");
        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntom '["alice"]' -p alice@active
        ...
        void prntom(name user)
        {
            ...
            if (iter->om)
            {
                ...
                core_net::print("size of stored om:", mpval.size()," vals:");
                for (auto it2 = mpval.begin(); it2 != mpval.end(); ++it2)
                    core_net::print(it2->first, ":", it2->second, "  ");

            }
            else
                core_net::print("optional<mp_uint16> has NULL value\n");
        }


        /*Examples:
         *  core-cli --verbose push action nestcontn2a setop '["alice", {"first":60, "second":61}]' -p alice@active
         *
        ...
        {
            SETCONTAINERVAL(op);
            core_net::print("type-defined optional-pair optional<pr_unit16> stored successfully!");
        }

        /*Examples:
         *  core-cli --verbose push action nestcontn2a  prntop '["alice"]' -p alice@active
        ...
        void prntop(name user)
        {
            PRNTCHECK();
            if (iter->op)
                core_net::print("stored optional<pr_unit16> data:", iter->op.value().first, " ", iter->op.value().second);
            else
                core_net::print("optional<pr_unit16> has NULL value\n");
        }
        ...
        {
            SETCONTAINERVAL(mst);
            core_net::print("type-defined map<K, set<T> > stored successfully!");
        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntmst '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("stored map<uint16_t, set_uint16>: size=", iter->mst.size()," content:\n");
            for (auto it2 = iter->mst.begin(); it2 != iter->mst.end(); ++it2)
            {
                    core_net::print(it2->first, ":", "vals ");
        ...
        {
            SETCONTAINERVAL(mv);
            core_net::print("type defined map<K, vector<T> > stored successfully!");
        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntmv '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("stored map<uint16_t, vec_uint16>: size=", iter->mv.size()," content:\n");
        ...
        {
            SETCONTAINERVAL(mo);
            core_net::print("type defined map<K, optional<T> > stored successfully!");
        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntmo '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("size of stored mo:", iter->mo.size()," vals\n");
            for (auto it2 = iter->mo.begin(); it2 != iter->mo.end(); ++it2)
            {
                core_net::print(it2->first, ":");
                if (it2->second)
                    core_net::print(it2->second.value()," ");
                else
                    core_net::print("NULL ");
            }
        }
        ...
        /*Example:
         *  core-cli push action nestcontn2a setmm '["alice", [{"key":10,"value":[{"first":200,"second":2000}, {"first":201,"second":2001}] }, {"key":11,"value":[{"first":300,"second":3000}, {"first":301,"second":3001}] } ]]' -p alice@active
        ...
        {
            SETCONTAINERVAL(mm);
            core_net::print("type defined map<K1,map<K2, V> > stored successfully!");
        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntmm '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("stored map<uint16_t, mp_uint16> val:");
            core_net::print("size=", iter->mm.size()," vals are the following:\n");
            for (auto it2 = iter->mm.begin(); it2 != iter->mm.end(); ++it2)
            {
                core_net::print(it2->first,"--->\n");
                const auto& temp = it2->second;
                for (auto it3 = temp.begin(); it3 != temp.end(); ++it3)
                    core_net::print("\t",it3->first, ":", it3->second, "\n");
            }
        }
        ...
        {
            SETCONTAINERVAL(mp);
            core_net::print("type-defined map-pair map<uint16_t, pr_unit16> stored successfully!");
        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntmp '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("size of stored mp:", iter->mp.size()," vals:\n");
            for (auto it2 = iter->mp.begin(); it2 != iter->mp.end(); ++it2)
                core_net::print(it2->first, ":", it2->second.first, " ", it2->second.second, "\n");
        }
        ...
        {
            SETCONTAINERVAL(pst);
            core_net::print("type-defined pair-set pair<uint32_t, set_uint16> stored successfully!");
        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntpst '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("content of stored pair<uint32_t, set_uint16>: first=", iter->pst.first, "\nsecond=");
        ...
        {
            SETCONTAINERVAL(pv);
            core_net::print("type-defined pair-vector pair<uint32_t, vec_uint16> stored successfully!");
        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntpv '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("content of stored pair<uint32_t, vec_uint16>: first=", iter->pv.first, "\nsecond=");
            for (const auto& ele: iter->pv.second)
                core_net::print(ele, " ");
        }

        /*Examples:
         *  core-cli --verbose push action nestcontn2a setpo '["alice", {"first":70, "second":71}]' -p alice@active
         *
        ...
        {
            SETCONTAINERVAL(po);
            core_net::print("type-defined pair-optional pair<uint32_t, op_uint16> stored successfully!");
        }

        /*Examples:
         *  core-cli --verbose push action nestcontn2a  prntpo '["alice"]' -p alice@active
         *      output: >> content of stored pair<uint16_t, op_unit16>: first=70
         *              >> second=71
         *
         *  core-cli --verbose push action nestcontn2a  prntpo '["bob"]' -p bob@active
         *      output: >> content of stored pair<uint16_t, op_unit16>: first=70
         *              >> second=NULL
         */
        [[clang::annotate("core_net::action")]]
        ...
        {
            PRNTCHECK();
            core_net::print("content of stored pair<uint16_t, op_unit16>: first=", iter->po.first, "\nsecond=");
            if (iter->po.second)
                core_net::print(iter->po.second.value(), " ");
            else
                core_net::print("NULL ");
        }
        ...
        {
            SETCONTAINERVAL(pm);
            core_net::print("type-defined pair-map pair<uint16_t, mp_uint16> stored successfully!");
        }

        /*Examples:
         *  core-cli --verbose push action nestcontn2a  prntpm '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("content of stored pair<uint16_t, mp_uint16>: first=", iter->pm.first, "\nsecond=");
        ...
        {
            SETCONTAINERVAL(pp);
            core_net::print("type-defined pair-pair pair<uint16_t, pr_unit16> stored successfully!");
        }

        /*Example:
         * core-cli --verbose push action nestcontn2a  prntpp '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("content of stored pair<uint16_t, pr_unit16>: first=", iter->pp.first, "\nsecond=");
            core_net::print(iter->pp.second.first, " ", iter->pp.second.second);
        }
        ...
        void setovv(name user, const optional<vecvec_uint32>& ovv)
        {
            ...
            SETCONTAINERVAL(ovv);
            core_net::print("type-defined optional<vecvec_uint32> stored successfully!");

        }

        /*Example:
         *  core-cli --verbose push action nestcontn2a  prntovv '["alice"]' -p alice@active
        ...
        {
            PRNTCHECK();
            core_net::print("stored optional<vector<vector<T> > > vals:\n");
            if (iter->ovv)
            {
              ...
              for (int i=0 ; i < v2.size(); i++)
              {
                for (int j=0; j < v2[i].size(); j++)
                    core_net::print(v2[i][j], " ");
                core_net::print("\n");
              }
            }
            else
                core_net::print("stored optional<vector<vector<T> > >  has null value!");
        }
        ...
        void erase(name user)
        {
            ...
            check(iter != tblIndex.end(), "Record does not exist");
            tblIndex.erase(iter);
            core_net::print("record erased successfully");
        }
