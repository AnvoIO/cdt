...
// Defined in `cdt/libraries/core_net/varint.hpp`
CORE_NET_TEST_BEGIN(unsigned_int_type_test)
...
// Defined in `cdt/libraries/core_net/varint.hpp`
CORE_NET_TEST_BEGIN(signed_int_type_test)
   //// signed_int(uint32_t)
...
CORE_NET_TEST_BEGIN(unsigned_int_constexpr_test)
   //// unsigned_int(uint32_t)
...
CORE_NET_TEST_BEGIN(signed_int_constexpr_test)
   //// signed_int(uint32_t)
...
int main(int argc, char* argv[]) {
   ...
   CORE_NET_TEST(unsigned_int_type_test)
   CORE_NET_TEST(signed_int_type_test);
   CORE_NET_TEST(unsigned_int_constexpr_test);
   CORE_NET_TEST(signed_int_constexpr_test);
   return has_failed();
}
