...
CORE_NET_TEST_BEGIN(name_type_test_ctr_num)
   //// constexpr name()
...
CORE_NET_TEST_BEGIN(name_type_test_ctr_str_lit)
...
CORE_NET_TEST_BEGIN(name_type_test_str_not_allowed)
...
CORE_NET_TEST_BEGIN(name_type_test_char_to_value)
   // --------------------------------------------
...
CORE_NET_TEST_BEGIN(name_type_test_allowed_chars)
...
CORE_NET_TEST_BEGIN(name_type_test_str_len)
   // -------------------------------
...
CORE_NET_TEST_BEGIN(name_type_test_str_too_long)
   CHECK_ASSERT( "string is too long to be a valid name", ([]() {name{"12345abcdefghj"}.length();}) )
CORE_NET_TEST_END

CORE_NET_TEST_BEGIN(name_type_test_suffix)
   // ----------------------------
...
CORE_NET_TEST_BEGIN(name_type_test_prefix)
   // ----------------------------
...
CORE_NET_TEST_BEGIN(name_type_test_raw)
   // -----------------------------
...
CORE_NET_TEST_BEGIN(name_type_test_op_bool)
   // ---------------------------------------
...
CORE_NET_TEST_BEGIN(name_type_test_memcmp)
   // ----------------------------------------
...
CORE_NET_TEST_BEGIN(name_type_test_to_str)
   // -----------------------
...
CORE_NET_TEST_BEGIN(name_type_test_equal)
   // ----------------------------------------------------------
...
CORE_NET_TEST_BEGIN(name_type_test_not_equal)
   // -----------------------------------------------------------
   // friend constexpr bool operator!=(const name&, const name&)
...
CORE_NET_TEST_BEGIN(name_type_test_less_than)
   // ---------------------------------------------------------
   // friend constexpr bool operator<(const name&, const name&)
...
CORE_NET_TEST_BEGIN(name_type_test_op_n)
   // ------------------------------------
...
int main(int argc, char* argv[]) {
   ...
   CORE_NET_TEST(name_type_test_ctr_num)
   CORE_NET_TEST(name_type_test_ctr_str_lit)
   CORE_NET_TEST(name_type_test_str_not_allowed)
   CORE_NET_TEST(name_type_test_char_to_value)
   CORE_NET_TEST(name_type_test_allowed_chars)
   CORE_NET_TEST(name_type_test_str_len)
   CORE_NET_TEST(name_type_test_suffix)
   CORE_NET_TEST(name_type_test_prefix)
   CORE_NET_TEST(name_type_test_raw)
   CORE_NET_TEST(name_type_test_op_bool)
   CORE_NET_TEST(name_type_test_memcmp)
   CORE_NET_TEST(name_type_test_to_str)
   CORE_NET_TEST(name_type_test_equal)
   CORE_NET_TEST(name_type_test_not_equal)
   CORE_NET_TEST(name_type_test_less_than)
   CORE_NET_TEST(name_type_test_op_n)
