...
// Definitions in `cdt/libraries/core_net/symbol.hpp`
CORE_NET_TEST_BEGIN(symbol_code_type_test)
...
// Definitions in `cdt/libraries/core_net/symbol.hpp`
CORE_NET_TEST_BEGIN(symbol_type_test)
...
// Definitions in `cdt/libraries/core_net/symbol.hpp`
CORE_NET_TEST_BEGIN(extended_symbol_type_test)
...
int main(int argc, char* argv[]) {
   ...
   CORE_NET_TEST(symbol_code_type_test);
   CORE_NET_TEST(symbol_type_test);
   CORE_NET_TEST(extended_symbol_type_test);
   return has_failed();
}
