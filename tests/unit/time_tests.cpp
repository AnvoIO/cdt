...
// Definitions in `cdt/libraries/core_net/time.hpp`
CORE_NET_TEST_BEGIN(microseconds_type_test)
...
// Definitions in `cdt/libraries/core_net/time.hpp`
CORE_NET_TEST_BEGIN(time_point_type_test)
   ...
   CHECK_EQUAL( time_point::from_iso_string("2038-01-19T03:14:07").elapsed.count(), 2147483647000000LL);
...
// Definitions in `cdt/libraries/core_net/time.hpp`
CORE_NET_TEST_BEGIN(time_point_sec_type_test)
   static const microseconds ms0 { 0LL};
   static const microseconds ms1 { 1LL};
   static const microseconds msn1{-1LL};
   static const microseconds ms_min{i64min};
   ...
   CHECK_EQUAL( time_point_sec::from_iso_string("1998-06-15T08:13:12").utc_seconds, 897898392);
   CHECK_EQUAL( time_point_sec::from_iso_string("2020-01-01T00:00:00").utc_seconds, 1577836800);
   CHECK_EQUAL( time_point_sec::from_iso_string("2038-01-19T03:14:07").utc_seconds, 2147483647);
   CHECK_ASSERT( "date parsing failed", [](){ time_point_sec::from_iso_string("2010-12-0aT00:00:00"); });

   // --------------------------------------------------------------------
   // std::string to_string()
   CHECK_EQUAL( time_point_sec{0}.to_string(),          "1970-01-01T00:00:00");
...
// Definitions in `cdt/libraries/core_net/time.hpp`
CORE_NET_TEST_BEGIN(block_timestamp_type_test)
...
int main(int argc, char* argv[]) {
   ...
   CORE_NET_TEST(microseconds_type_test);
   CORE_NET_TEST(time_point_type_test);
   CORE_NET_TEST(time_point_sec_type_test);
   CORE_NET_TEST(block_timestamp_type_test);
   return has_failed();
}
