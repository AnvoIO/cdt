   ...
   public:
      ...
      void mallocpass() {
         ...
         *ptr5 = ((__int128_t(0x6666666666666666) << 64) | 0x6666666666666666);
         ...
         core_net::check(*ptr0 == 0x11, "wrong value for char");
         core_net::check(*ptr1 == 0x2222, "wrong value for short");
         core_net::check(*ptr2 == 0x33333333, "wrong value for int");
         core_net::check(*ptr3 == 0x4444444444444444, "wrong value for long long");
         core_net::check(*ptr4 == ((__int128_t(0x5555555555555555) << 64) | 0x5555555555555555), "wrong value for __int128 #1");
         core_net::check(*ptr5 == ((__int128_t(0x6666666666666666) << 64) | 0x6666666666666666), "wrong value for __int128 #2");
         core_net::check(ptr6[0] == ((__int128_t(0x7777777777777777) << 64) | 0x7777777777777777), "wrong value for __int128[2] #1");
         core_net::check(ptr6[1] == ((__int128_t(0x7777777777777777) << 64) | 0x7777777777777777), "wrong value for __int128[2] #1");
         core_net::check(ptr7[0] == ((__int128_t(0x8888888888888888) << 64) | 0x8888888888888888), "wrong value for __int128[2] #2");
         core_net::check(ptr7[1] == ((__int128_t(0x8888888888888888) << 64) | 0x8888888888888888), "wrong value for __int128[2] #2");
         core_net::check(ptr8[0] == 0x9999999999999999, "wrong value for long long[3] #1");
         core_net::check(ptr8[1] == 0x9999999999999999, "wrong value for long long[3] #1");
         core_net::check(ptr8[2] == 0x9999999999999999, "wrong value for long long[3] #1");
         core_net::check(ptr9[0] == 0xAAAAAAAAAAAAAAAA, "wrong value for long long[3] #2");
         core_net::check(ptr9[1] == 0xAAAAAAAAAAAAAAAA, "wrong value for long long[3] #2");
         core_net::check(ptr9[2] == 0xAAAAAAAAAAAAAAAA, "wrong value for long long[3] #2");
      }
