...
class [[eosio::contract]] multi_index_large : public contract {
   public:
      ...
      struct [[eosio::table("data")]] main_record {
         ...
         const core_net::checksum256& get_chk256()const  { return chk256; }

         EOSLIB_SERIALIZE( main_record, (id)(u64)(u128)(f64)(f128)(chk256))
      };

      using test_tables = core_net::multi_index<"testtaba"_n, main_record,
         core_net::indexed_by< "byuu"_n,   core_net::const_mem_fun< main_record, uint64_t,
                                                            &main_record::get_u64 > >,
         core_net::indexed_by< "byuuuu"_n,   core_net::const_mem_fun< main_record, uint128_t,
         ...
         core_net::indexed_by< "bychkb"_n, core_net::const_mem_fun< main_record, const core_net::checksum256&,
