...
namespace core_net {
   ...
   inline DataStream& operator<<(DataStream& ds, const ::core_net::ignore_wrapper<T>& val) {
     ds << val.value;
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator<<(DataStream& ds, const ::core_net::ignore<T>& val) {
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator>>(DataStream& ds, ::core_net::ignore<T>&) {
     return ds;
   }
}
