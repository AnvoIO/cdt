 ...
 *  @details Database C API provides low level interface to the database.
 *
...
/**
  ...
  *  core_net_assert(itr >= 0, "Alice cannot be removed since she was already not found in the table");
  *  db_remove_i64(itr);
  *  @endcode
  */
__attribute__((core_net_wasm_import))
...
/**
  ...
  *  core_net_assert(len <= 50, "buffer to small to store retrieved record");
