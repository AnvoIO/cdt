...
extern "C" volatile uint64_t core_net_contract_name = 0;
extern "C" volatile void core_net_set_contract_name(uint64_t n) { core_net_contract_name = n; } // LLVM creates the call to this at the beginning of apply
