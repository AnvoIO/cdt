...
namespace core_net {
   ...
   */
    ...
    * ```
    *
    * For this to work the Actions must be derived from core_net::contract
    *
    * @ingroup dispatcher
    *
    */
   ...
   bool dispatch( uint64_t code, uint64_t act ) {
      ...
      return core_net::dispatch<Contract,SecondAction,Actions...>( code, act );
   }
    ...
    *
    * @ingroup dispatcher
    * @tparam T - The contract class that has the correponding action handler, this contract should be derived from core_net::contract
 ...
 *
 * @ingroup dispatcher
 * @note To be able to use this macro, the contract needs to be derived from core_net::contract
