...
#include "../../core/core_net/hash_id.hpp"
...
namespace core_net {
   ...
   inline int64_t call(core_net::name receiver, uint64_t flags, const char* data, size_t data_size) {
    ...
    * @endcode
    */
   template <core_net::hash_id::raw Func_Name, auto Func_Ref, access_mode Access_Mode=access_mode::read_write, support_mode Support_Mode = support_mode::abort_op>
   struct call_wrapper {
      ...
      static constexpr core_net::hash_id function_name = core_net::hash_id(Func_Name);
      core_net::name receiver {};
