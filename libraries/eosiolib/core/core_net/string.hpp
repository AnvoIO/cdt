...
#include "datastream.hpp" // core_net::datastream
#include "varint.hpp"     // core_net::unsigned_int
...
namespace core_net {
   ...
   public:
      ...
      char& at(const size_t n) {
         core_net::check(0 <= n && n < _size, "core_net::string::at");
         return operator[](n);
      }

      const char at(const size_t n) const {
         core_net::check(0 <= n && n < _size, "core_net::string::at const");
         return operator[](n);
      }
      ...
      size_t copy(char* s, size_t len, size_t pos = 0) const {
         core_net::check(pos <= _size, "core_net::string::copy");
      ...
      string& insert(const size_t pos, const char* str, const size_t len) {
         core_net::check((str != nullptr) && (0 <= pos && pos <= _size), "core_net::string::insert");
      ...
      string& erase(size_t pos = 0, size_t len = npos) {
         core_net::check(0 <= pos && pos <= _size, "core_net::string::erase");
      ...
      string& append(const char* str) {
         core_net::check(str != nullptr, "core_net::string::append");
         insert(_size, str);
