...
#include <core_net/crypto_ext.h>
#include <core_net/crypto_bls_ext.h>
#include <core_net/db.h>
#include <core_net/instant_finality.h>
...
namespace core_net { namespace native {
...
#define GENERATE_TYPE_MAPPING(name) \
   struct __ ## name ## _types { \
      using deduced_full_ts = decltype(core_net::native::get_args_full(::name)); \
      using deduced_ts      = decltype(core_net::native::get_args(::name)); \
...
#define GET_TYPE(name) \
   decltype(create_function<core_net::native::intrinsics::__ ## name ## _types::res_t, \
         core_net::native::intrinsics::__ ## name ## _types::deduced_full_ts>(core_net::native::intrinsics::__ ## name ## _types::is)),

#define REGISTER_INTRINSIC(name) \
   create_function<core_net::native::intrinsics::__ ## name ## _types::res_t, \
         core_net::native::intrinsics::__ ## name ## _types::deduced_full_ts>(core_net::native::intrinsics::__ ## name ## _types::is),
