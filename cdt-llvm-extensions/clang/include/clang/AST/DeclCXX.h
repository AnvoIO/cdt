...
class CXXBasePath;
class CoreNetActionAttr;
class CoreNetCallAttr;
class CoreNetTableAttr;
class CoreNetContractAttr;
class CoreNetRicardianAttr;
class CoreNetReadOnlyAttr;
class CoreNetIgnoreAttr;
class CoreNetNotifyAttr;
class CXXBasePaths;
...
public:
  ...
  bool isCoreNetContract() const;
  bool isCoreNetAction() const;
  bool isCoreNetCall() const;
  bool isCoreNetTable() const;
  bool isCoreNetIgnore() const;
  bool hasCoreNetRicardian() const;
  bool isCoreNetReadOnly() const;
  CoreNetActionAttr* getCoreNetActionAttr() const;
  CoreNetCallAttr* getCoreNetCallAttr() const;
  CoreNetTableAttr* getCoreNetTableAttr() const;
  CoreNetContractAttr* getCoreNetContractAttr() const;
  CoreNetRicardianAttr* getCoreNetRicardianAttr() const;
  CoreNetReadOnlyAttr* getCoreNetReadOnlyAttr() const;
...
public:
  ...
  bool isCoreNetAction() const;
  bool isCoreNetCall() const;
  bool isCoreNetNotify() const;
  bool isCoreNetContract() const;
  bool hasCoreNetRicardian() const;
  bool isCoreNetReadOnly() const;
  CoreNetActionAttr* getCoreNetActionAttr() const;
  CoreNetCallAttr* getCoreNetCallAttr() const;
  CoreNetNotifyAttr* getCoreNetNotifyAttr() const;
  CoreNetContractAttr* getCoreNetContractAttr() const;
  CoreNetRicardianAttr* getCoreNetRicardianAttr() const;
  CoreNetReadOnlyAttr* getCoreNetReadOnlyAttr() const;
