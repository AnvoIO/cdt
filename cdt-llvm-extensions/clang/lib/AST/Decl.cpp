...
// CXXRecordDecl CDT methods (moved from inline in DeclCXX.h for LLVM 18 compatibility)
bool CXXRecordDecl::isCoreNetContract() const { return hasAttr<CoreNetContractAttr>(); }
bool CXXRecordDecl::isCoreNetAction() const { return hasAttr<CoreNetActionAttr>(); }
bool CXXRecordDecl::isCoreNetCall() const { return hasAttr<CoreNetCallAttr>(); }
bool CXXRecordDecl::isCoreNetTable() const { return hasAttr<CoreNetTableAttr>(); }
bool CXXRecordDecl::isCoreNetIgnore() const { return hasAttr<CoreNetIgnoreAttr>(); }
bool CXXRecordDecl::hasCoreNetRicardian() const { return hasAttr<CoreNetRicardianAttr>(); }
bool CXXRecordDecl::isCoreNetReadOnly() const { return hasAttr<CoreNetReadOnlyAttr>(); }
CoreNetActionAttr* CXXRecordDecl::getCoreNetActionAttr() const { return getAttr<CoreNetActionAttr>(); }
CoreNetCallAttr* CXXRecordDecl::getCoreNetCallAttr() const { return getAttr<CoreNetCallAttr>(); }
CoreNetTableAttr* CXXRecordDecl::getCoreNetTableAttr() const { return getAttr<CoreNetTableAttr>(); }
CoreNetContractAttr* CXXRecordDecl::getCoreNetContractAttr() const { return getAttr<CoreNetContractAttr>(); }
CoreNetRicardianAttr* CXXRecordDecl::getCoreNetRicardianAttr() const { return getAttr<CoreNetRicardianAttr>(); }
CoreNetReadOnlyAttr* CXXRecordDecl::getCoreNetReadOnlyAttr() const { return getAttr<CoreNetReadOnlyAttr>(); }

// CXXMethodDecl CDT methods
bool CXXMethodDecl::isCoreNetAction() const { return hasAttr<CoreNetActionAttr>(); }
bool CXXMethodDecl::isCoreNetCall() const { return hasAttr<CoreNetCallAttr>(); }
bool CXXMethodDecl::isCoreNetNotify() const { return hasAttr<CoreNetNotifyAttr>(); }
bool CXXMethodDecl::isCoreNetContract() const { return hasAttr<CoreNetContractAttr>(); }
bool CXXMethodDecl::hasCoreNetRicardian() const { return hasAttr<CoreNetRicardianAttr>(); }
bool CXXMethodDecl::isCoreNetReadOnly() const { return hasAttr<CoreNetReadOnlyAttr>(); }
CoreNetActionAttr* CXXMethodDecl::getCoreNetActionAttr() const { return getAttr<CoreNetActionAttr>(); }
CoreNetCallAttr* CXXMethodDecl::getCoreNetCallAttr() const { return getAttr<CoreNetCallAttr>(); }
CoreNetNotifyAttr* CXXMethodDecl::getCoreNetNotifyAttr() const { return getAttr<CoreNetNotifyAttr>(); }
CoreNetContractAttr* CXXMethodDecl::getCoreNetContractAttr() const { return getAttr<CoreNetContractAttr>(); }
CoreNetRicardianAttr* CXXMethodDecl::getCoreNetRicardianAttr() const { return getAttr<CoreNetRicardianAttr>(); }
CoreNetReadOnlyAttr* CXXMethodDecl::getCoreNetReadOnlyAttr() const { return getAttr<CoreNetReadOnlyAttr>(); }
